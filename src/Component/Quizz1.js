...
import questions from "./Quizz1Data";
import Quizz1Result from "./Quizz1Result";
...
const Quizz1 =()=> {
    ...
    return (
        ...
        <div className="quizzContainer">
            {showResult?(<Quizz1Result handlePlayAgain={handlePlayAgain} score={score} CorrectAns={correctAns}/>):(
